...
<?php
    ...
    if ( have_posts() ) {
        ...
        while ( have_posts() ) { the_post();
                                    ...
                                    <div class="product-slider__slider overview-link-sd">
                                        <div class="product-slider__item overview-item-sd">
                                            <div class="overview-link-div">
                                                <a class="overview-mob-link-sd active" href="#overview"><h2 class="" style="color:black;">Overview</h2></a>
                                            </div>
                                        </div>
                                        <div class="product-slider__item overview-item-sd">
                                            <div class="overview-link-div-sd">
                                                <a class="overview-mob-link-sd" href="#pricing"><h2 class="" style="color:black;">Pricing</h2></a>
                                            </div>
                                        </div>
                                        <div class="product-slider__item overview-item-sd">
                                            <div class="overview-link-div-sd">
                                                <a class="overview-mob-link-sd" href="#resources"><h2 class="" style="color:black;">Resources</h2></a>
                                            </div>
                                        </div>
                                        <div class="product-slider__item overview-item-sd">
                                            <div class="overview-link-div-sd">
                                                <a class="overview-mob-link-sd" href="#applications"><h2 class="" style="color:black;">Applications</h2></a>
            ...
            <section class="product-tab-section-sd" id="overview">
                <div class="container-fluid">
                   <div class="row">
                       <div class="col-md-12 col-sm-12 col-12">
                           <div class="row">
                               ...
                               <?php 
                                    $i_url = get_the_post_thumbnail_url(get_the_ID() );
                                    if (empty($i_url)) {
                                        $i_url = "/wp-content/uploads/2021/01/Rectangle-95-2.png";
                                    }
                               ?>
                               <div class="col-md-10 col-sm-12 col-12">
                                   <div class="main tabs-product-div-sd">
                                        <div class="right-sd">
                                            <img class="w-100 sd-overview-img mb-5" src="<?php echo $i_url;?>" >
            ...
            <section class="slider-sections rel-serv-sd">
                <div class="container-fluid">
                    <div class="row">
                            ...
                            <div class="related-slider sd">
                                <div class="product-slider">
                                    <div class="product-slider__slider related sd">
                                        <?php foreach (get_field('images', get_the_ID()) as $key => $value): ?>
                                            <div class="product-slider__item related-item">
                                                <div class="rel-serv-div-sd">
                                                    <img class=" m-0" src="<?php echo $value['image'];?>">
                                                </div>
                                            </div>
                                        <?php endforeach ?>
                                    </div>
            ...
            <section class="resources-sections-sd" id="pricing">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-2">
                        </div>
                            ...
                            <div class="row pricing-main-row-sd">
                                <div class="col-md-12">
                                    <table class="rricing-table-sd">
                                        <tbody>
                                            <?php foreach (get_field('pricing', get_the_ID()) as $key => $value): ?>
            ...
            <section class="resources-sections-sd" id="resources">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-2">
                        </div>
                                ...
                                <?php foreach (get_field('resources', get_the_ID()) as $key => $value): ?>
                                    <div class="col-md-6">
                                        <div class="resource-div-sd"> 
                                            <a class="resource-btn-sd" href="<?php print_r(get_field( "file", $value['resource']->ID ));?>"><i class="fas fa-download download-icon-sd"></i><?php print_r($value['resource']->post_title);?></a>
                                        </div>
                                    </div>
                                <?php endforeach ?>
                            </div>
            ...
            <section class="service-sd-sec" id="applications">
