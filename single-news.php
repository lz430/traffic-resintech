...
<style type="text/css"> 
    ...
    div.nd-tabs-div a.nav-item.nav-link:hover {
        color: #cc163f;
    }
    ...
    .post-content-nd h5:hover {
color: #cc163f;
    cursor: pointer;

    }
     .post-content-nd h5 a:hover {
...
cursor: pointer;
    ...
    a.view-more-btn-nd:hover {

        color: #cc163f !important;
    }
...
<section class="nd-sect-one" data-aos="fade-up"
    data-aos-offset="50"
    data-aos-delay="50"
    ...
    <div class="container">
        ...
        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <p class="date-cat-nd"><?php echo get_the_date( 'd.m.y', get_the_ID() ); ?> |<span><?php echo get_the_category(get_the_ID())[0] ->name; ?></p>
                ...
                <p class="auther-name-nd">Author:  <?php echo get_the_author(); ?></p>

                <img class="w-100 detail-blog-img-nd" src="<?php echo get_the_post_thumbnail_url(get_the_ID() );?>">
...
<section class="nd-blog-sect" data-aos="fade-up"
    data-aos-offset="100"
    data-aos-delay="50"
    data-aos-duration="1000"
    data-aos-easing="ease-in-out"
                ...
                <div class="tab-content" id="nav-tabContent">
                  	...
                  	<div class="tab-pane fade show active" id="nd-all" role="tabpanel" aria-labelledby="nav-all-tab">
                  	    ...
                  	    <div class="container">
                  	        ...
                  	        <div class="row nd-post-row-all"  id='all-news'>
                              <?php
								...
								?>
                  	            <div class="col-lg-4 col-md-4 col-sm-6 col-6 nd-post-col-set" data-aos="fade-up"
    data-aos-offset="100"
    data-aos-delay="50"
    data-aos-duration="1000"
    data-aos-easing="ease-in-out"
    ...
    data-aos-anchor-placement="top-center">
                  	                ...
                  	                <div class="nd-post-div">
                  	                   ...
                  	                   <div class="img-detail"> <img class="w-newsdetail" src="<?php echo get_the_post_thumbnail_url(get_the_ID());?>"></div>

                  	                    <div class="post-content-nd">

                  	                        <p class="date-cat-nd"><?php echo get_the_date( 'd.m.y', get_the_ID() ); ?> |<span> <?php echo get_the_category(get_the_ID())[0] ->name; ?></span></p>
                              ...
                              <a class="view-more-btn-nd" id="more_posts">View more</a>
                  	...
                  	<div class="tab-pane fade" id="nd-blog" role="tabpanel" aria-labelledby="nd-blog-tab">
                  		...
                  		<div class="container">
                  	        ...
                  	        <div class="row nd-post-row-all" id='all-blog'>
                              <?php
									$args = array(  
									'post_type' => 'news',
									'post_status' => 'publish',
                  	        ...
                  	        <a class="view-more-btn-nd" id="more_blog">View more</a>
                  	...
                  	<div class="tab-pane fade" id="nd-press" role="tabpanel" aria-labelledby="nd-press-tab">
                  		...
                  		<div class="container">
                  	        ...
                  	        <div class="row nd-post-row-all" id='all_press'>
                              <?php
									$args = array(  
									'post_type' => 'news',
									'post_status' => 'publish',
                  	        ...
                  	        <a class="view-more-btn-nd" id="press_news">View more</a>
                  	...
                  	<div class="tab-pane fade" id="nd-trade" role="tabpanel" aria-labelledby="nd-trade-tab">
                  		...
                  		<div class="container">
                  	        ...
                  	        <div class="row nd-post-row-all" id='all-trade'>
                              <?php
									$args = array(  
									'post_type' => 'news',
									'post_status' => 'publish',
...
<div class="img-detail"><img class="w-newsdetail" src="<?php echo get_the_post_thumbnail_url(get_the_ID() );?>"></div>
                  	        ...
                  	        <a class="view-more-btn-nd" id="all_trade">View more</a>
